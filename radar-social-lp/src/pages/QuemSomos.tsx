...
const QuemSomos: React.FC = () => {
  return (
    <>
      <section id="sobre" className="bg-brand-orange text-white py-30 px-4">
        <div className="container mx-auto grid md:grid-cols-2  items-center">
          <div className="flex items-center justify-start">
            <img
              src={QuemSomosImg}
              alt="Ilustração sobre inovação social"
              className="rounded-lg h-130 w-auto"
            />
          </div>
          <div>
            <h2 className="font-sans text-5xl md:text-7xl text-start mb-2">
              A inovação não se
            </h2>
            <h2 className="font-heading text-center text-5xl md:text-7xl mb-6">
              FAZ SOZINHA
            </h2>
            <p className="font-pt-sans text-center text-brand-purple text-lg md:text-3xl leading-relaxed ">
              Conheça o Radar Social e quem foi<br></br> responsável por torná-lo possível!
            </p>
          </div>
      ...
      <div className="container mx-auto">
        ...
        <div className="flex items-center gap-4  text-start">
          <span className="font-heading text-4xl md:text-7xl text-black">
            Sobre o
          </span>
        ...
        <div className="grid md:grid-cols-2 gap-2 items-center">
          ...
          <div className="font-pt-sans text-xl md:text-2xl text-lg text-black leading-relaxed text-justify">
            <p>
          ...
          <div>
            <img 
              ...
              className="rounded-lg  w-120 h-auto translate-x-50"
            />
          </div>
      ...
      <section id="equipe" className="py-24 px-4 bg-white">
        <div className="container mx-auto">
          <div className="flex items-center gap-4  text-start mb-16">
          <span className="font-heading text-4xl md:text-7xl text-black">
            QUEM FAZ O
          </span>
          <div className="text-black">
            ...
            {teamMembers.map((member) => (
              ...
              >
                ...
                <div className="pt-20 p-6 text-center">
                  ...
                  <hr className="my-4 border-t border-gray-200 color-brand-purple-light" />
